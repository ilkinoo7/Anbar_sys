        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/brands_data">
                            <span class="icon-bg"><i class="mdi mdi-archive"></i></span>
                            <span class="menu-title">Brend</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{route('clients_data')}}">
                            <span class="icon-bg"><i class="mdi mdi-archive"></i></span>
                            <span class="menu-title">Müştəri</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{route('products_data')}}">
                            <span class="icon-bg"><i class="mdi mdi-archive"></i></span>
                            <span class="menu-title">Məhsul</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{route('orders_data')}}">
                            <span class="icon-bg"><i class="mdi mdi-archive"></i></span>
                            <span class="menu-title">Sifariş</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item sidebar-user-actions">
                        <div class="sidebar-user-menu">
                            <a href="{{route('signin')}}" class="nav-link"><i class="mdi mdi-logout menu-icon"></i>
